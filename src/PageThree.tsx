...
function PageThree() {
  ...
  useEffect(() => {
    if (location.pathname === "/page2") setActive("image");
  ...
  return (
    ...
    >
      ...
      <TopRightIcon />
      <div className="flex justify-center items-center min-h-screen w-[800px] h-[650px]">
        <div className="w-[300px] h-[650px]">
          {/* Bạn có thể thay ImageGallery bằng component VideoGallery nếu muốn */}
          <VideoGallery/>
        </div>
      </div>
